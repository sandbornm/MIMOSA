...
def get_parser():
	...
	parser.add_argument('--mode', '-m', type=str, default='train', help='training mode [train | cross_val | test | predict | strat]. default: train')
	...
	parser.add_argument('-b', '--batch_size', type=int, default=16, help='batch size. default: 16', dest='batchsize')
	parser.add_argument('-l', '--learning-rate', type=float, default=1e-3, help='Learning rate. default: 1e-3', dest='lr')
